...
| FR-28 | Installation and rollback shall remain manual. Workflow handoff/approval jobs shall create environment deployment records that represent the selected artifact handoff or stable publication and link to its run/release-set evidence; they shall not claim installation occurred. Operators shall wait for successful publication of the complete selected set before installing it; partial publication shall not count as an installed deployment. |
